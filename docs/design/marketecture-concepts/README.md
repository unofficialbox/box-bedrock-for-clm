# Marketecture Design Concepts

These images are visual design references for the generated executive HTML artifacts. They are not screenshots of live Box, Salesforce, AgentCore, or Databricks environments and must not be used as implementation-readiness evidence.
...
The generated HTML files use code-native text, interactions, responsive layouts, embedded real-demo proof screenshots, and embedded official platform logos. The concept PNGs preserve the visual design intent for future iterations. The SDK and Harness variants are clean-background, 300-DPI naming studies; they do not yet have corresponding HTML artifacts.
