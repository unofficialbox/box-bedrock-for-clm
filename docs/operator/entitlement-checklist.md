...
| Salesforce API-only integration user | Box Automate Agentic Orchestration | Salesforce admin | Minimum-access integration profile/license is available |
| Salesforce External Client App | Box Automate Agentic Orchestration | Salesforce admin | External Client App Manager allows client credentials and Run As configuration |
