...
- [Calder demo run sheet](../../../../../DEMO-RUN-SHEET.html) -- the executive walkthrough as a single presenter page: preflight checks, every prompt as copy-paste, and what each beat should return. Open it in a browser. Site URL and counterparty login are placeholders; bind them to your environment first.
