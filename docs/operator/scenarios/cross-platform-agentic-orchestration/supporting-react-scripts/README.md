...
| [Box metadata entry-point variation](04-box-form-automate-entry.md) | 5-7 minutes | Any audience | Start with a contract uploaded to `01 - Intake` and `clmContract` metadata applied, then Automate enrichment, human validation, and HTTPS Connector record creation |

Supporting artifacts:

- [Demo flow diagram](../../../../diagrams/clm-box-agentforce-react-demo-flow.svg)
- [Box metadata entry-point diagram](../../../../diagrams/clm-box-form-automate-entry.svg)
